...
> **プレビュー** — v0.1.0 は最初の公開エンジニアリングプレビューでした。v0.1.5 で Figma V4 の高精度 UI を実装しました。
...
- ホーム / ドキュメント / テンプレート / 設定ナビゲーションに加え、マップ / アウトライン / 分割ビュー
- Figma V4 に沿ったグローバルシェル、レイアウト、寸法、間隔、角丸、文字、コントロール状態
- 重複しない 7 つの設定カテゴリ: 一般、言語と地域、外観、編集、ファイル、エクスポート、このアプリについて
